  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-purple-950 flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-6xl mb-4">
        <div className="bg-gradient-to-r from-cyan-500/10 to-purple-500/10 backdrop-blur-sm border border-cyan-500/30 rounded-2xl p-4 shadow-lg shadow-cyan-500/20">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              <Link
                to="/"
                title="Back Games"
                className="w-12 h-12 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-lg flex items-center justify-center shadow-lg shadow-cyan-500/50"
              >
      ...
      <div className="relative w-full max-w-6xl">
        <div className="relative w-full aspect-[2/1] bg-gradient-to-b from-slate-900/50 to-slate-950/50 backdrop-blur-xl border-2 border-cyan-500/30 rounded-2xl overflow-hidden shadow-2xl shadow-purple-500/20">
          ...
          {/* Ground */}
          <div className="absolute bottom-0 w-full h-[10%] bg-gradient-to-t from-cyan-900/30 to-transparent border-t-2 border-cyan-500/30"></div>

          {/* Platforms */}
          {platforms.map((platform, idx) => (
            <div
              key={idx}
              className="absolute bg-gradient-to-br from-cyan-500/20 to-purple-500/20 backdrop-blur-sm border-2 border-cyan-400/50 shadow-lg shadow-cyan-500/30 rounded-lg"
              style={{
          ...
          {/* Ninja */}
          <div
            className="absolute bg-gradient-to-br from-slate-900 to-slate-950 border-2 border-cyan-500/50 rounded-lg shadow-xl shadow-cyan-500/50 transition-transform duration-75"
            style={{
          ...
          {hasWon && (
            <div className="absolute inset-0 bg-slate-950/95 backdrop-blur-md flex flex-col items-center justify-center">
              <div className="text-center space-y-6 p-8">
                ...
                <h2 className="text-6xl font-bold bg-gradient-to-r from-cyan-400 via-emerald-400 to-purple-400 bg-clip-text text-transparent animate-pulse">
                  MISSION COMPLETE
                </h2>
                <div className="bg-gradient-to-r from-cyan-500/20 to-purple-500/20 backdrop-blur-sm border border-cyan-500/30 rounded-xl p-6 shadow-2xl">
                  <p className="text-2xl text-cyan-300 mb-2">Time Elapsed</p>
                ...
                <button
                  onClick={resetGame}
                  className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-400 hover:to-purple-400 text-white font-bold rounded-xl transition-all shadow-lg shadow-cyan-500/50 hover:shadow-xl hover:shadow-purple-500/50 hover:scale-105"
                >
                  RESTART MISSION
                </button>
              </div>
        ...
        <div className="mt-6 flex justify-center gap-4 md:hidden">
          <button
            ...
            className="w-20 h-20 bg-gradient-to-br from-cyan-500/30 to-purple-500/30 backdrop-blur-sm border-2 border-cyan-400/50 rounded-xl flex items-center justify-center text-3xl shadow-lg shadow-cyan-500/30 active:scale-95 transition-transform"
          >
            ←
          </button>
          <button
        ...
        {/* Controls Info */}
        <div className="mt-6 bg-gradient-to-r from-cyan-500/10 to-purple-500/10 backdrop-blur-sm border border-cyan-500/30 rounded-xl p-4 shadow-lg">
          ...
          <p className="text-center text-purple-300/70 text-xs mt-2">
            Reach the glowing door to complete the mission
          </p>
        </div>
      </div>
    </div>
